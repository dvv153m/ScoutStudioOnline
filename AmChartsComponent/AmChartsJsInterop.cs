...
namespace AmChartsComponent
{
    ...
    public class AmChartsJsInterop : IAsyncDisposable
    {
        ...
        public AmChartsJsInterop(IJSRuntime jsRuntime)
        {
            moduleTask = new(() => jsRuntime.InvokeAsync<IJSObjectReference>(
               "import", "./_content/AmChartsComponent/amChartsJsInterop.js").AsTask());
        }
