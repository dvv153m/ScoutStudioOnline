...
window.amcharts = {
    ...
    init: function (countPoints, chartModelsJson) {
        ...
        am4core.ready(function () {
            ...
            //если браузер будет слишком тупить при загрузке графиков можно раскоментить строку ниже(графики будут последовательно загружатьс€)
            ...
            function createSlider() {
                ...
                //≈сли рассто€ние между точками данных меньше X пикселей, скрыть все маркеры(Bullet)
